...
#define        ERROR_INIT_SOCKET "Failed to create socket\n"
#define        ERROR_SETSOCKOPT  "Failed to set sockopt\n"
...
#define        ERROR_ACCEPT      "Accept failed\n"
...
#define        ERROR_IOCTL	 "Ioctl failed to assert socket data\n"
