...
** Last update Sat Nov 15 15:35:00 2014 Jean-Philippe Roemer
*/
...
static int      match_loop(t_regex *this, regmatch_t *m,
...
int             match(t_regex *this, const char *str)
{
  ...
  p = str;
  if ((this->_f_match = malloc(MATCH_MALLOC(this->_n_match)
                               * sizeof(char*))) == NULL)
    return (1);
  while (42) {
...
int		t_regex_init(t_regex *this, const char *regex,
                             const int nbr_match, const int flags) {
  int		status;
